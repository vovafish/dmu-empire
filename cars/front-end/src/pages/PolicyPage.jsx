...
const PolicyPage = () => {
  return (
    <main className="mainContainer">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Car Empire Inc, 73 London Road BATH BA45
            8LV.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CAR EMPIRE, accessible from{' '}
            <a
              href="http://www.car-empire.com"
              rel="noreferrer"
              target="_blank"
            >
              http://www.car-empire.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: carempire@gmail.com</p>
        </li>
        <li>
